...
const Calender = props => {
  ...
  document.title = "Calendar | Power Robotics - Responsive Bootstrap 5 Admin Dashboard";
  ...
  const handleEventClick = arg => {
    ...
    setEvent({
      ...
      start: event.start,
      className: event.className || event.classNames,
      category: Array.isArray(event.classNames) ? event.classNames[0] : (event.className || "bg-primary"),
      event_category: Array.isArray(event.classNames) ? event.classNames[0] : (event.className || "bg-primary"),
    })
    setIsEdit(true)
    toggle()
  }
